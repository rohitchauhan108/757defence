...
export default function CriminalDefenseServicePage() {
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
          <div className="max-w-4xl space-y-4">
            ...
            <div className="flex flex-wrap gap-3 pt-4">
              ...
              <button onClick={() => router.push('/contact')} className="inline-flex items-center gap-2.5 px-7 py-4 bg-[#FAF8F5]/5 hover:bg-[#D9AD74]/10 border border-[#D9AD74]/40 hover:border-[#D9AD74] text-[#F5F2ED] rounded-xs transition-all group">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center">
            ...
            <div className="lg:col-span-6 lg:order-1 space-y-6">
              ...
              <button onClick={() => router.push('/attorneys')} className="group inline-flex items-center gap-3 px-7 py-4 bg-[#12100E] hover:bg-[#D9AD74] hover:text-[#0F0F0F] text-[#F5F2ED] border-2 border-[#12100E] hover:border-[#D9AD74] rounded-xs transition-all">
          ...
          <div className="mt-20 text-center">
            <button onClick={() => router.push('/practice-areas')} className="group inline-flex items-center gap-3 px-10 py-4.5 bg-[#12100E] hover:bg-[#0F0F0F] text-[#F5F2ED] border-2 border-[#D9AD74] rounded-xs shadow-xl hover:shadow-[0_20px_40px_-12px_rgba(217,173,116,0.4)] transition-all">
      ...
      <section className="bg-[#0F0E0C] text-[#F5F2ED] py-20 px-6 lg:px-8 border-t border-[#D9AD74]/20">
        <div className="max-w-5xl mx-auto text-center space-y-6">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
            <button onClick={() => router.push('/contact')} className="group inline-flex items-center gap-3 px-10 py-5 bg-[#D9AD74] hover:bg-[#B88D51] text-[#0F0F0F] rounded-xs shadow-2xl transition-all">
