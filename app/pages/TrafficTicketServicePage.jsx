...
export default function TrafficTicketServicePage() {
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
          <div className="max-w-4xl space-y-4">
            ...
            <div className="flex flex-wrap gap-3 pt-4">
              ...
              <button onClick={() => router.push('/contact')} className="inline-flex items-center gap-2.5 px-7 py-4 bg-[#FAF8F5]/5 hover:bg-[#D9AD74]/10 border border-[#D9AD74]/40 hover:border-[#D9AD74] rounded-xs transition-all group">
      ...
      <section className="bg-gradient-to-br from-[#D9AD74] via-[#E8C191] to-[#B88D51] py-16 md:py-20 px-6 lg:px-8 overflow-hidden relative">
        ...
        <div className="max-w-5xl mx-auto relative z-10 text-center space-y-6">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
            <button onClick={() => router.push('/contact')} className="group inline-flex items-center gap-3 px-10 py-5 bg-[#0F0E0C] hover:bg-black text-[#D9AD74] rounded-xs shadow-2xl transition-all">
