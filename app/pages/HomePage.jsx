        ...
        <div className="max-w-7xl mx-auto space-y-12 relative z-10">
          ...
          >
            ...
            <div className="lg:col-span-7 space-y-4 text-xs sm:text-sm text-[#3D3A35] font-light leading-relaxed">
              <p>
                757 Defense delivers aggressive, trial-tested criminal
                representation across Virginia Beach, Norfolk, Chesapeake,
                Portsmouth, Hampton, and Newport News courts. Founded by former
                public defender, we know exactly how the Commonwealth builds its
                case—and how to dismantle it.
              </p>
              <p>
                Whether you face DUI charges, reckless driving, domestic
                violence allegations, drug distribution or other criminal
                charges you will need an expert in criminal defense to protect
                your rights your good name and your freedom
              </p>
            </div>
          </motion.div>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10">
          ...
          >
            ...
            <p className="text-[#D8D4CE]/70 text-xs sm:text-sm font-light leading-relaxed">
              When your freedom, reputation, and your well being are on the
              line, you need criminal attorneys who know local judges and
              Commonwealth prosecutors inside and out.
            </p>
        ...
        <div className="max-w-7xl mx-auto space-y-12">
          ...
          >
            ...
            <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-2 gap-6 text-xs text-[#524E48] font-light leading-relaxed">
              <p>
                We review Commonwealth’s evidence : inspect every police
                breathalyzer calibration, officer bodycam recording, witness
                testimonies and field sobriety test protocol for constitutional
                violations.
              </p>
              <p>
                From motion hearings to jury trials, 757 Defense leaves no stone
                unturned to safeguard your driving record and freedom.
              </p>
            </div>
          </motion.div>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              >
                <div className="font-crimson text-4xl sm:text-5xl font-bold text-[#D9AD74]">
                  {stat.num}
                </div>
                <div className="text-xs uppercase tracking-wider text-[#D8D4CE]/80 font-light">
                  {stat.label}
                </div>
              </motion.div>
            ))}
            ...
            <div className="lg:col-span-7 p-8 sm:p-12 space-y-6">
              <div>
                ...
                <p className="text-xs text-[#524E48] font-light mt-1">
                  Connect immediately with senior criminal partners Anton Karpov
                  or Gregory Pugh.
                </p>
              </div>
              ...
              <form onSubmit={handleApptSubmit} className="space-y-4">
                ...
                {apptSubmitted && (
                  <p className="text-xs text-emerald-800 font-bold pt-2">
                    ✓ Request transmitted! A senior 757 Defense trial lawyer
              ...
              <div className="sm:w-3/5 p-6 sm:p-8 flex flex-col justify-between space-y-4">
                <div className="space-y-3">
                  ...
                  <p className="text-xs text-[#D8D4CE]/80 font-light leading-relaxed pt-1">
                    Obtained his Law Degree in 2006 from William & Mary Law
                    School. He began his legal career as a Public Defender in
                    Virginia Beach. For twelve years, he fought fiercely and
                    passionately for each client, tried hundreds of criminal
                    cases, argued legal motions in Juvenile, General District,
                    and Circuit Courts, and argued before the Virginia Court of
                    Appeals and Supreme Court of Virginia.
                  </p>
                </div>
            ...
            >
              ...
              <div className="sm:w-3/5 p-6 sm:p-8 flex flex-col justify-between space-y-4">
                <div className="space-y-3">
                  ...
                  <p className="text-xs text-[#D8D4CE]/80 font-light leading-relaxed pt-1">
                    Obtained his Juris Doctor degree from Pettit College of Law
                    at Ohio Northern University in 1981 and an advanced Master
                    of Laws Degree (LLM) from William & Mary in 1991. He has
                    actively practiced in Virginia courts since 1988 and opened
                    his own practice in 1996, specializing in civil litigation,
                    bankruptcy, traffic, and criminal defense.
                  </p>
                </div>
        ...
        <div className="max-w-7xl mx-auto space-y-12">
          ...
          >
            <div className="flex items-center gap-4">
              <span className="font-crimson text-6xl font-bold text-[#D9AD74]">
                55+
              </span>
            ...
            <div className="text-center">
              <span className="font-crimson text-4xl font-bold text-[#F5F2ED] block">
                1,000+
              </span>
              <span className="text-xs text-[#D8D4CE]/60 uppercase tracking-wider">
                Criminal & Defended Cases
              </span>
            </div>

            <div className="text-center">
              <span className="font-crimson text-4xl font-bold text-white block"></span>
              <span className="text-lg text-white uppercase tracking-wider">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              {
                title: "DUI & DWI",
                tag: "Virginia Beach & Norfolk",
                img: "https://images.unsplash.com/photo-1589829545856-d10d557cf95f?q=80&w=600&auto=format&fit=crop",
              },
              {
                title: "Reckless Driving",
                tag: "Speeding & Traffic Defense",
                img: "https://images.unsplash.com/photo-1453728013993-6d66e9c9123a?q=80&w=600&auto=format&fit=crop",
              },
              {
                title: "Domestic Violence",
                tag: "Protective Orders & Assault",
      ...
      <section className="relative bg-[#0E0C0A] text-[#F5F2ED] py-24 px-6 lg:px-8 border-t border-[#D9AD74]/20 overflow-hidden">
        <div className="max-w-4xl mx-auto text-center space-y-6 relative z-10">
          ...
          <p className="text-xs sm:text-sm text-[#D8D4CE]/70 max-w-xl mx-auto font-light leading-relaxed">
            Stay informed on changes to Virginia criminal laws, DUI defense
            strategies, and court procedures in Virginia Beach and Norfolk.
          </p>
